...
type OrderQuote struct {
	...
	OrderQuoteAddress         *OrderQuoteAddress   `gorm:"foreignKey:quote_id;references:id" json:"-"`
	OrderQuotePayment         *OrderQuotePayment   `gorm:"foreignKey:quote_id;references:id" json:"-"`
